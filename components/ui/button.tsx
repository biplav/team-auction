...
// Debounce hook to prevent rapid button clicks
function useDebounce(callback: (...args: any[]) => void, delay: number = 300) {
...
function Button({
  ...
  // Debounce the onClick handler to prevent rapid successive clicks
  ...
  return (
    <Comp
      ...
      onClick={asChild ? onClick : debouncedOnClick}
      {...props}
    />
  )
}
